...
import { ipcRenderer, remote, Menu, popupMenu } from "../utils";
              ...
              {Array.from(new Array(numPages), (_, i) => (
                <Box
                  ...
                  style={{
                    ...
                    height: pageHeight,
                    visibility: pageHeight !== undefined ? "visible" : "hidden",
